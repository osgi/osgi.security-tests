package com.sogetiht.otf.util.command;
...
import com.sogetiht.otf.util.provider.UtilImpl;

import osgi.enroute.debug.api.Debug;

/**
 * This is the implementation. It registers the Util interface and calls it
 * through a Gogo command.
 * 
 */
@Component(service=UtilActivator.class, property = { Debug.COMMAND_SCOPE + "=util",
		Debug.COMMAND_FUNCTION + "=util" }, name="com.sogetiht.otf.util.command")
