package com.sogetiht.otb.util.api;
...
public class UtilImpl implements Util
{
    ...
    public UtilImpl(BundleContext context, boolean displayBox, boolean displayServer,
                 String serverIP, int serverPort, int serverDPort, int serverSPort,
	...
	private void DEBUG(String field, int value)
    {
        System.out.println("DEBUG: "+field+"="+value);
    }

    @SuppressWarnings("unused")
	private void DEBUG(String field, long value)
    {
        System.out.println("DEBUG: "+field+"="+value);
    }

    @SuppressWarnings("unused")
	private void DEBUG(String field, boolean value)
    {
        System.out.println("DEBUG: "+field+"="+value);
    }
    ...
    public String getResourcePath(String name, Class<?> bundle) throws Exception {
        ...
        //URL resource = bundle.getResource("/META-INF/resources/" + name);
        //if (resource != null)
        //  try {
        //    response = resource.toURI().toString();
        //  } catch (Exception e) {
        //    err(e);
        //  }
        //return response;
            ...
            if (socket != null && displayServer)
                if (socket.isConnected()) {
                    try {
                        ...
                        if (debug) {err(e);e.printStackTrace();}
                    }
                }
        } catch(Exception e) {
            err(e);
